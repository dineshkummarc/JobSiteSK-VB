<%@ Page Language="VB" MasterPageFile="~/MasterPage.master" AutoEventWireup="false" CodeFile="jobpostings.aspx.vb" Inherits="jobpostings" title="Untitled Page" %>
    ...
    <br />
        ...
        <asp:GridView ID="GridView1" Runat="server" DataSourceID="ObjectDataSource1" AllowPaging="True"
            ...
            <Columns>
                ...
                <asp:ButtonField ButtonType="Image" ImageUrl="~/Images/ShowDetails.gif">
